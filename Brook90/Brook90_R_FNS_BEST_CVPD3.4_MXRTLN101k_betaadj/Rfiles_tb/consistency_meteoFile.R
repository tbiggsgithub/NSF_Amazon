...
#' 
## -------------------------------------------------------------------------------------------------------------------------
SCRIPTPATH <-"K:/My Drive/Gdrive/mydocuments/amazon/writeups/2019_NSF_SSiB_1D/Rfiles/Brook90/Brook90_R_FNS/Input_data/"
meteoFile <-read.table(file.path(SCRIPTPATH,"data_input_WB_1999_point.txt"),dec=".")

meteoFile <-read.table(file.path(SCRIPTPATH,"FNSmet.txt"),dec=".")
