...
indir.gldas.vars = "K:/Shared drives/Rondonia_CNH/Data/Data processing and outputs/water_variables/GLDAS/earthdata/GLDAS_NOAH025_M/v2.1.2000.2022/"
varnames = c("Rainf","RootMoist_inst","SWdown","Swnet_tavg","Tair", "PotEvap","Qair")

units = c("kg.m2.s","kg.m2","Wm2","Wm2","C","kg.m2.s","kg.kg")
  # Units definitions here:
  #  https://docs.google.com/document/d/18AIxWk9oUoGZjUdpOODsY7ck0Bng__AiwyjjjkPOQpI/edit
conversion.to.mm = c(86400,1,1,1,1,86400,1)   # kg/m2/s x 3600sx24h/day x 1m3/1000kg x 1000mm/m  = 86400
...
for (var.index in 1:length(varnames)){
  ...
  flist.var = flist.var[grep("2022",flist.var,invert=TRUE)]
  ...
  fname.out = paste0("GLDAS_NOAH025_M_v21_2000_2021_",varnames[var.index],".csv")
