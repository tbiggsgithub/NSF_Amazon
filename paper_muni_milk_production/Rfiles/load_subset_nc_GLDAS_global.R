...
indir.gldas = "C:/Users/tbiggs/GLDAS/"
  indir.gldas = "C:/Users/tbiggs/GLDAS/GLDAS_NOAH_1980_2014/"
outdir.gldas.ambasin =  "K:/Shared drives/Rondonia_CNH/Data/Data processing and outputs/water_variables/GLDAS/earthdata/GLDAS_NOAH025_M/"
setwd(indir.gldas)
...
varlist = c("Evap_tavg","SoilMoist_RZ_tavg", "TWS_tavg","Swnet_tavg")
varlist = c("AvgSurfT_tavg")

flist.dates = as.Date(substr(flist,22,29),format="%Y%m%d")
flist.years = as.numeric(format(flist.dates,"%Y"))
